...
files = gb.glob("obama.jpg")  # Get list of all images with emotion
filenumber = 0
for f in files:
    ...
    for (x, y, w, h) in facefeatures:  # get coordinates and size of rectangle containing face
        ...
        try:
            ...
            cv2.imwrite("C:\\Users\\N550\\PycharmProjects\\ReadMyFace\\example\\%s.jpg" % ( filenumber), out)  # Write image
